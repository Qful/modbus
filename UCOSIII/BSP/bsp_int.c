...
static void IntHandlerTim2(void);
static void IntHandlerUSART1(void);
...
void  BSP_IntInit (void)
{
    ...
    BSP_IntVectSet(BSP_INT_ID_TIM2, IntHandlerTim2);
    BSP_IntVectSet(BSP_INT_ID_USART1, IntHandlerUSART1); 
}
